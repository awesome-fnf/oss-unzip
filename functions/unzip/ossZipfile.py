...
def _EndRecData64(fpin, offset, endrec):
    ...
    if hasattr(fpin, 'bucket'):
        data = fpin.get_content_bytes(fpin.filesize+offset-sizeEndCentDir64Locator, fpin.filesize+offset-1)
    else:
        try:
...
class ZipFile:
    ...
    def _RealGetContents(self):
        ...
        if hasattr(fp, "bucket"):
            data = fp.get_content_bytes(self.start_dir, self.start_dir+size_cd-1)
        else:
